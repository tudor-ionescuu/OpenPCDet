...
echo "Testing PointPillar Ultralight on nuScenes..."
python test.py \
    ...
    --infer_time \
    2>&1 | tee ../logs/test_pointpillar_ultralight_nuscenes_full.txt

echo "Test completed! Full log saved to logs/test_pointpillar_ultralight_nuscenes_full.txt"
