#!/bin/bash
#SBATCH --job-name=test_casa_v-ultralight
#SBATCH --nodes=1
...
#SBATCH --mem=32GB
#SBATCH --time=0:30:00
#SBATCH --output=logs/casa/ultralight/%j.out
#SBATCH --error=logs/casa/ultralight/%j.err
...
python tools/test.py \
    ...
    --batch_size 1 \
    --ckpt output/cfgs/kitti_models/CasA-V_Ultralight/ultralight_full/ckpt/checkpoint_epoch_80.pth \
    --infer_time
