#!/bin/bash
#SBATCH --job-name=test_pp_ultra_kitti
#SBATCH --nodes=1
...
#SBATCH --mem=32GB
#SBATCH --time=1:00:00
#SBATCH --output=logs/test_pointpillar_ultralight_kitti_%j.out
#SBATCH --error=logs/test_pointpillar_ultralight_kitti_%j.err
...
echo "Testing PointPillar Ultralight on KITTI..."
